	...
	public String toString() {
		...
		if(values.size()>0) {
			...
			for(int i=0;i<values.size();i++) {
				...
				switch(type) {
					case TrimToNull: sqlInsert.append(StringUtil.isBlank(value=StringUtil.trim(value))?"null":"'"+value+"'"); break;
					case TrimToEmpty: sqlInsert.append("'"+StringUtil.trim(value)+"'"); break;
